...
//@param    	nil
//@return    	m       	*node					旋转后的原节点
func (n *node) rightThenLeftRotate() (m *node) {
	//右旋转,之后左旋转
	//以失衡点右结点先右旋转
...
//@param    	nil
//@return    	m       	*node					旋转后的原节点
func (n *node) LeftThenRightRotate() (m *node) {
	//左旋转,之后右旋转
	//以失衡点左结点先左旋转
...
//		替换后删除该节点
//@auth      	hlccd		2021-07-11
//@receiver		n			*node					接受者node的指针
//@param    	e			interface{}				待删除元素
//@param    	isMulti		bool					是否允许重复?
//@param    	cmp			comparator.Comparator	判断大小的比较器
//@return    	b        	bool					是否删除成功?
func (n *node) delete(e interface{}, cmp comparator.Comparator) (m *node, b bool) {
	if n == nil {
		//待删除值不存在,删除失败
		return n, false
	}
	if cmp(e, n.value) < 0 {
		//从左子树继续删除
		n.left, b = n.left.delete(e, cmp)
	} else if cmp(e, n.value) > 0 {
		//从右子树继续删除
		n.right, b = n.right.delete(e, cmp)
	} else if cmp(e, n.value) == 0 {
		//存在相同值,从该节点删除
		b = true
		if n.num > 1 {
			...
			if n.left != nil && n.right != nil {
				...
				n.right, b = n.right.delete(n.value, cmp)
			} else if n.left != nil {
				n = n.left
			} else {
				n = n.right
...
func (n *node) search(e interface{}, isMulti bool, cmp comparator.Comparator) (num int) {
	if n == nil {
		return 0
	}
